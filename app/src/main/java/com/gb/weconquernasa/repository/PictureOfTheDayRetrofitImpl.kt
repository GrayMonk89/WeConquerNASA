...
class PictureOfTheDayRetrofitImpl : PictureOfTheDayRepository {
    ...
    override fun getPictureOfTheDay(key: String, date: String, callback: PictureOfTheDayViewModel.Callback) {

        val pictureOfTheDayAPI = MyApp.getRetrofit()

        pictureOfTheDayAPI.getPictureOfTheDay(BuildConfig.NASA_API_KEY, date)
